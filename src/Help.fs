...
type Help =
    ...
    static member Main() = 
        Html.div [
            ...
            prop.children [
                Html.h1 [
                    prop.className "text-2xl font-bold mb-4 pl-4"
                    ...
                    prop.children [
                        Html.div [
                            ...
                            prop.children [
                                ...
                                Html.ul [
                                    prop.className "menu bg-base-200 rounded-box"
                                    prop.children [
                                        Html.li [
                                            Html.a [
                                                prop.href "#about"
                                                ...
                                                Html.p [
                                                    ...
                                                    prop.children [
                                                        ...
                                                        Html.a [
                                                            ...
                                                            prop.target.blank 
                                                            prop.className "underline text-blue-400 pl-1.5"
                                                        ]
                                                    ]
                                                ]
                                                Html.p [
